...
SYSTEMD_SETUP() {
  ...
  sed -i -e 's/REDIS_ENDPOINT/redis.devops69.online/' -e 's/CATALOGUE_ENDPOINT/catalogue.devops69.online/' -e 's/USERHOST/user.devops69.online/' -e 's/USERHOST/dev-payment.sarbjeet310.online/' /home/roboshop/${COMPONENT}/systemd.service &>>$LOG
