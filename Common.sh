...
SYSTEMD_SETUP() {
  ...
  sed -i -e 's/REDIS_ENDPOINT/redis.sarbjeet310.online/' -e 's/CATALOGUE_ENDPOINT/catalogue.sarbjeet310.online/' -e 's/USERHOST/user.sarbjeet310.online/'  /home/roboshop/${COMPONENT}/systemd.service &>>$LOG
